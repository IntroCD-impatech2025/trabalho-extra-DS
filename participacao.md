...
| altair_data_transformation.ipynb      | Tradução 3.2         | 3.2 |  Henrique Assis     |
| altair_data_transformation.ipynb      | Tradução 3.3         | 3.3 |   Bruno Pereira    |
| altair_data_transformation.ipynb      | Tradução 3.3.1         | 3.3.1 |  Bruno Pereira     |
...
| altair_cartographic.ipynb      | Tradução 7.3             | 7.3 |Bruno Pereira    |
...
|      |              |  |     |
| altair_debugging.ipynb      | Tradução ADG            | ADG |     Marcos Abílio  |
| altair_debugging.ipynb      | Tradução installation           | Installation |  Marcos Abílio     |
| altair_debugging.ipynb      | Tradução MSYAUTLVOA           | MSYAUTLVOA  |    Marcos Abílio   |
| altair_debugging.ipynb      | Tradução TMAC          | TMAC  |     Marcos Abílio  |
| altair_debugging.ipynb      | Tradução SSFTJN          | SSFTJN  |    Marcos Abílio   |
| altair_debugging.ipynb      | Tradução DT          | DT  |     Marcos Abílio  |
| altair_debugging.ipynb      | Tradução NEF          | NEF  |   Marcos Abílio    |
| altair_debugging.ipynb      | Tradução IS+IP         | IS+IP  |   Marcos Abílio    |
| altair_debugging.ipynb      | Tradução PABI          | PABI  |    Marcos Abílio   |
| altair_debugging.ipynb      | Tradução AFH+RI        | AFH+RI  |   Marcos Abílio    |
...
| Nome do Arquivo     | Descrição                    | Item   | Participante       |
|---------------------|-----------------------------|--------|------------------|
|intro.md      | Revisão Introdução do site VC+I             |VC+I  |    Pedro Carvalho |
|intro.md      | Revisão Introdução do site GS             |GS  | Pedro Carvalho    |
|intro.md      | Revisão Introdução do site LI      |LI  |   Pedro Carvalho  |
|intro.md      | Revisão Introdução do site Creditos           |Creditos  | Pedro Carvalho  |
|      |              |  |     |
| altair_marks_encoding.ipynb      | Revisão 2         | 2 | Jonathas David  |
| altair_marks_encoding.ipynb      | Revisão 2.1         | 2.1 |Jonathas David      |
| altair_marks_encoding.ipynb      | Revisão 2.2         | 2.2 |   Jonathas David    |
| altair_marks_encoding.ipynb      | Revisão 2.2.1         | 2.2.1 |    Henrique Assis  |
| altair_marks_encoding.ipynb      | Revisão 2.2.2         | 2.2.2 |    Henrique Assis  |
| altair_marks_encoding.ipynb      | Revisão 2.2.3         | 2.2.3 |   Henrique Assis   |
| altair_marks_encoding.ipynb      | Revisão 2.2.4         | 2.2.4 |   Henrique Assis   |
| altair_marks_encoding.ipynb      | Revisão 2.2.5         | 2.2.5 |   Henrique Assis   |
...
| altair_marks_encoding.ipynb      | Revisão 2.3.3         | 2.3.3 |  Jonathas David    |
| altair_marks_encoding.ipynb      | Revisão 2.3.3         | 2.3.3 |  Jonathas David    |
| altair_marks_encoding.ipynb      | Revisão 2.3.4         | 2.3.4 |  Jonathas David    |
| altair_marks_encoding.ipynb      | Revisão 2.3.5         | 2.3.5 | Jonathas David     |
| altair_marks_encoding.ipynb      | Revisão 2.3.6         | 2.3.6 |   Jonathas David   |
| altair_marks_encoding.ipynb      | Revisão 2.3.7         | 2.3.7 |  Jonathas David    |
| altair_marks_encoding.ipynb      | Revisão 2.3.8         | 2.3.8 |  Jonathas David    |
| altair_marks_encoding.ipynb      | Revisão 2.4         | 2.4 |   Jonathas David   |
| altair_marks_encoding.ipynb      | Revisão 2.4.1         | 2.4.1 |  Jonathas David    |
| altair_marks_encoding.ipynb      | Revisão 2.4.2         | 2.4.2 |  Jonathas David    |
| altair_marks_encoding.ipynb      | Revisão 2.4.3         | 2.4.3 |  Jonathas David    |
| altair_marks_encoding.ipynb      | Revisão 2.4.4         | 2.4.4 |  Jonathas David    |
| altair_marks_encoding.ipynb      | Revisão 2.4.5         | 2.4.5 |  Jonathas David    |
| altair_marks_encoding.ipynb      | Revisão 2.4.6         | 2.4.6 | Jonathas David     |
| altair_marks_encoding.ipynb      | Revisão 2.4.7         | 2.4.7 | Jonathas David     |
|      |              |  |     |
...
| altair_data_transformation.ipynb      | Revisão 3.2         | 3.2 |   Henrique Assis   |
...
|      |              |  |     |
| altair_debugging.ipynb      | Revisão ADG            | ADG |   Henrique Assis    |
| altair_debugging.ipynb      | Revisão installation           | Installation |   Henrique Assis    |
| altair_debugging.ipynb      | Revisão MSYAUTLVOA           | MSYAUTLVOA  |  Henrique Assis     |
| altair_debugging.ipynb      | Revisão TMAC          | TMAC  | Henrique Assis      |
| altair_debugging.ipynb      | Revisão SSFTJN          | SSFTJN  |  Henrique Assis     |
| altair_debugging.ipynb      | Revisão DT          | DT  |   Henrique Assis    |
| altair_debugging.ipynb      | Revisão NEF          | NEF  |   Henrique Assis    |
| altair_debugging.ipynb      | Revisão IS+IP         | IS+IP  | Henrique Assis      |
